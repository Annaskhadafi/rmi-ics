...
def main():
    ...
    print(f"Scraping Carbon Black data from {url}...")
    ...
    try:
        ...
        if pricing_table:
            print("Found Carbon Black pricing table.")
            ...
            for row in rows[1:]:
                ...
                if len(cols) > max(region_idx, price_idx):
                    ...
                    if price != "N/A":
                        ...
                        material_name = f"Carbon Black ({region_clean})"
            ...
            print("Could not find the Carbon Black pricing table on the page.")
